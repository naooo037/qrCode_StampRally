...
export const RallyApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		deleteRally: async (
			...
			const localVarPath = `/rallies/{rally_id}`.replace(
				`{${'rally_id'}}`,
				encodeURIComponent(String(rallyId))
			)
		 ...
		 * @throws {RequiredError}
		 */
		getRallyStamps: async (
			rallyId: string,
			options: RawAxiosRequestConfig = {}
		): Promise<RequestArgs> => {
			// verify required parameter 'rallyId' is not null or undefined
			assertParamExists('getRallyStamps', 'rallyId', rallyId)
			const localVarPath = `/rallies/{rally_id}/stamps`.replace(
				`{${'rally_id'}}`,
				encodeURIComponent(String(rallyId))
			)
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
		 ...
		 */
		postRally: async (
			postRallyRequest: PostRallyRequest,
			options: RawAxiosRequestConfig = {}
		): Promise<RequestArgs> => {
		 ...
		 * @throws {RequiredError}
		 */
		postRallyStamp: async (
			rallyId: string,
			postRallyStampRequest: PostRallyStampRequest,
			options: RawAxiosRequestConfig = {}
		): Promise<RequestArgs> => {
			// verify required parameter 'rallyId' is not null or undefined
	...
	return {
		...
		async deleteRally(
			...
			const localVarOperationServerBasePath =
				operationServerMap['RallyApi.deleteRally']?.[localVarOperationServerIndex]?.url
		...
		async getRallies(
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RallySchema>>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getRallies(options)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['RallyApi.getRallies']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async getRally(
			rallyId: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RallySchemaWithStamps>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getRally(rallyId, options)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['RallyApi.getRally']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async getRallyStamps(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['RallyApi.getRallyStamps']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async postRally(
			postRallyRequest: PostRallyRequest,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RallySchema>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.postRally(postRallyRequest, options)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['RallyApi.postRally']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		 ...
		 * @throws {RequiredError}
		 */
		async postRallyStamp(
			rallyId: string,
			postRallyStampRequest: PostRallyStampRequest,
			options?: RawAxiosRequestConfig
		): Promise<
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PostRallyStamp200Response>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.postRallyStamp(
				rallyId,
				postRallyStampRequest,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['RallyApi.postRallyStamp']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const RallyApiFactory = function (
	...
	return {
		...
		getRally(
			rallyId: string,
			options?: RawAxiosRequestConfig
		): AxiosPromise<RallySchemaWithStamps> {
		...
		postRally(
			postRallyRequest: PostRallyRequest,
			options?: RawAxiosRequestConfig
		): AxiosPromise<RallySchema> {
			return localVarFp
				.postRally(postRallyRequest, options)
		...
		postRallyStamp(
			...
			postRallyStampRequest: PostRallyStampRequest,
			options?: RawAxiosRequestConfig
		): AxiosPromise<PostRallyStamp200Response> {
			return localVarFp
				.postRallyStamp(rallyId, postRallyStampRequest, options)
				.then((request) => request(axios, basePath))
		},
	}
}
...
export class RallyApi extends BaseAPI {
	...
	public deleteRally(rallyId: string, options?: RawAxiosRequestConfig) {
		return RallyApiFp(this.configuration)
			.deleteRally(rallyId, options)
	...
	public getRallyStamps(rallyId: string, options?: RawAxiosRequestConfig) {
		return RallyApiFp(this.configuration)
			.getRallyStamps(rallyId, options)
			.then((request) => request(this.axios, this.basePath))
	}
...
export const StampApiAxiosParamCreator = function (configuration?: Configuration) {
	return {
		...
		deleteStamp: async (
			...
			const localVarPath = `/stamp/{stamp_id}`.replace(
				`{${'stamp_id'}}`,
...
export const StampApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async deleteStamp(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['StampApi.deleteStamp']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		 ...
		 * @throws {RequiredError}
		 */
		async postStampCollect(
			stampId: string,
			userId: string,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<DeleteUser200Response>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.postStampCollect(
				stampId,
				userId,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['StampApi.postStampCollect']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async putStamp(
			...
			postRallyStampRequest: PostRallyStampRequest,
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StampSchema>> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.putStamp(
				stampId,
				postRallyStampRequest,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['StampApi.putStamp']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
...
export const StampApiFactory = function (
	...
	return {
		...
		postStampCollect(
			...
			return localVarFp
				.postStampCollect(stampId, userId, options)
				.then((request) => request(axios, basePath))
		},
		/**
		 *
		...
		putStamp(
			...
			postRallyStampRequest: PostRallyStampRequest,
			options?: RawAxiosRequestConfig
		): AxiosPromise<StampSchema> {
			return localVarFp
				.putStamp(stampId, postRallyStampRequest, options)
				.then((request) => request(axios, basePath))
		},
	}
}
...
export const UserApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async getUserStamps(
			...
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['UserApi.getUserStamps']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
		...
		async getUsers(
			options?: RawAxiosRequestConfig
		): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<UserSchema>>> {
		...
		async postUserRegister(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.postUserRegister(
				postUserRegisterRequest,
				options
			)
			const localVarOperationServerIndex = configuration?.serverIndex ?? 0
			const localVarOperationServerBasePath =
				operationServerMap['UserApi.postUserRegister']?.[localVarOperationServerIndex]?.url
			return (axios, basePath) =>
				createRequestFunction(
					localVarAxiosArgs,
					globalAxios,
